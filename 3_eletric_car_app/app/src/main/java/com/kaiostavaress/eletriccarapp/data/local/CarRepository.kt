package com.kaiostavaress.eletriccarapp.data.local

import android.content.ContentValues
import android.content.Context
import android.provider.BaseColumns
import android.util.Log
import com.kaiostavaress.eletriccarapp.data.local.CarsContract.CarEntry.COLUMN_NAME_BATERIA
import com.kaiostavaress.eletriccarapp.data.local.CarsContract.CarEntry.COLUMN_NAME_CAR_ID
import com.kaiostavaress.eletriccarapp.data.local.CarsContract.CarEntry.COLUMN_NAME_POTENCIA
import com.kaiostavaress.eletriccarapp.data.local.CarsContract.CarEntry.COLUMN_NAME_PRECO
import com.kaiostavaress.eletriccarapp.data.local.CarsContract.CarEntry.COLUMN_NAME_RECARGA
import com.kaiostavaress.eletriccarapp.data.local.CarsContract.CarEntry.COLUMN_NAME_URL_PHOTO
import com.kaiostavaress.eletriccarapp.domain.Carro

class CarRepository (private val context: Context) {
    fun save(car: Carro) : Boolean {
        var isSaved = false
        try {
